...
namespace App.Sdk.Models {
    public class Thing : IParsable {
        /// <summary>The additionalDataProperty property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Thing_additionalData? AdditionalDataProperty { get; set; }
#nullable restore
#else
        public Thing_additionalData AdditionalDataProperty { get; set; }
#endif
...
#nullable restore
        ...
        public static Thing CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"additionalData", n => { AdditionalDataProperty = n.GetObjectValue<Thing_additionalData>(Thing_additionalData.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Thing_additionalData>("additionalData", AdditionalDataProperty);
